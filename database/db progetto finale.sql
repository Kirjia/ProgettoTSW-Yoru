...
INSERT INTO prodotto(nome, peso, prezzo, quantità, ID_casa_produttrice, category, descrizione)
VALUES
("Steins;Gate Collection", 90, 15, 537, 10, "Libro", "Una raccolta dell'universo di Steins;Gate, che esplora viaggi nel tempo, fisica quantistica e dilemmi etici."),
("Buchi Bianchi dentro l'orizzonte", 76, 14, 217, 13, "Libro", "Un'indagine affascinante sui misteri dei buchi bianchi, complementi speculari ai buchi neri."),
("Sette brevi lezioni di fisica", 36, 10, 189, 13, "Libro", "Carlo Rovelli offre un'introduzione accessibile alle idee più importanti della fisica moderna."),
("L'ordine del tempo", 215, 14, 178, 13, "Libro", "Un viaggio attraverso il concetto di tempo e come la fisica lo ridisegna in modi sorprendenti."),
("Sei pezzi facili", 211, 13, 198, 13, "Libro", "Una raccolta introduttiva ai concetti di base della fisica spiegati dal brillante Feynman."),
("Sei pezzi meno facili", 217, 13, 248, 13, "Libro", "Richard Feynman esplora concetti complessi di fisica con chiarezza e semplicità."),
("Schumacher la leggenda di un uomo normale", 198, 9, 67, 15, "Libro", "Una biografia di Michael Schumacher, l’uomo e la leggenda della Formula 1."),
("Che cos'è la scienza: la rivoluzione di Anassimandro", 127, 14, 87, 13, "Libro", "Carlo Rovelli esplora il pensiero di Anassimandro, uno dei primi filosofi-scienziati dell'antichità."),
("Relatività", 154, 15, 174, 16, "Libro", "Una spiegazione accessibile della teoria della relatività di Albert Einstein, adatta sia a neofiti che a esperti."),
("Enzo Ferrari: un eroe italiano", 157, 5.80, 76, 17, "Libro", "La vita e il percorso del fondatore della Ferrari, simbolo dell'eccellenza automobilistica italiana."),
("Ci sono luoghi al mondo dove più che le regole è importante la gentilezza", 305, 17.50, 143, 14, "Libro", "Una raccolta di riflessioni di Carlo Rovelli su scienza, filosofia e umanità."),
("Massa", 314, 18.50, 96, 13, "Libro", "La biografia di Felipe Massa, pilota di Formula 1, raccontata attraverso le sue esperienze in pista e fuori."),
("Bastava chiedere!", 255, 17, 102, 18, "Libro", "Un saggio fumettistico che affronta il carico mentale delle donne nella gestione della casa e della famiglia."),
("Smartwatch X1", 0.2, 99.99, 50, 20, "Gadget", "Un orologio intelligente con funzionalità avanzate, come monitoraggio della salute e notifiche in tempo reale."),
("Hoverboard Z2", 2.5, 299.99, 30, 21, "Gadget", "Un hoverboard di ultima generazione, perfetto per spostamenti rapidi e divertenti in città."),
("Neuralyzer 3000", 0.5, 49.99, 100, 17, "Gadget", "Un dispositivo futuristico che cancella la memoria recente, ideale per situazioni imbarazzanti."),
("Lightsaber MKII", 0.3, 149.99, 20, 16, "Gadget", "Una replica autentica della spada laser, perfetta per i fan di Star Wars e per le battaglie epiche."),
("Replicator 5000", 1.0, 499.99, 10, 12, "Gadget", "Un dispositivo in grado di creare oggetti 3D a partire da materiali grezzi, portando il futuro nella tua casa."),
("Sonic Screwdriver", 0.1, 29.99, 200, 11, "Gadget", "Un gadget versatile e indispensabile per ogni viaggiatore del tempo, utile in una miriade di situazioni."),
("Il signore degli anelli", 1.5, 20.99, 50, 10, "Libro", "Il classico fantasy epico di J.R.R. Tolkien, che racconta la lotta per distruggere un anello maledetto e salvare il mondo di Arda."),
("Harry Potter e la pietra filosofale", 1.2, 15.99, 70, 11, "Libro", "Il primo libro della serie di J.K. Rowling, che introduce il magico mondo di Hogwarts."),
("1984", 0.8, 12.99, 30, 12, "Libro", "Un romanzo distopico di George Orwell su una società dominata da un regime totalitario e sorvegliata dal Grande Fratello."),
("Il giovane Holden", 0.7, 10.99, 40, 13, "Libro", "La storia di un adolescente in lotta contro il conformismo, scritta da J.D. Salinger."),
("Cime tempestose", 1.0, 18.99, 25, 14, "Libro", "Un classico della letteratura gotica di Emily Brontë, che narra la passione selvaggia e vendicativa tra Heathcliff e Catherine."),
("Don Chisciotte", 1.3, 22.99, 35, 15, "Libro", "Il capolavoro di Miguel de Cervantes che racconta le avventure dell'idealista cavaliere Don Chisciotte e del suo fedele scudiero Sancho Panza."),
("Il grande Gatsby", 0.9, 14.99, 60, 16, "Libro", "Una storia di lusso, amore e tragedia negli anni '20 americani, scritta da F. Scott Fitzgerald."),
("Moby Dick", 1.8, 25.99, 20, 17, "Libro", "Il grande romanzo di Herman Melville sulla caccia ossessiva del capitano Achab alla balena bianca."),
("Orgoglio e Pregiudizio", 1.1, 16.99, 45, 18, "Libro", "Un romanzo di Jane Austen che esplora amore, orgoglio e pregiudizi tra le classi sociali della campagna inglese."),
("Cronache di Narnia", 1.4, 19.99, 55, 19, "Libro", "Una serie fantasy di C.S. Lewis che racconta le avventure di bambini che viaggiano nel magico regno di Narnia."),
("La ragazza con il drago tattoo", 1.2, 17.99, 38, 20, "Libro", "Un thriller avvincente di Stieg Larsson che combina mistero, omicidi e indagini digitali."),
("Lo Hobbit", 1.0, 14.99, 48, 21, "Libro", "La storia di un viaggio epico nel mondo della Terra di Mezzo scritta da J.R.R. Tolkien, prequel de 'Il Signore degli Anelli'."),
("Il nome della rosa", 1.5, 21.99, 42, 10, "Libro", "Un romanzo storico e di mistero di Umberto Eco ambientato in un'abbazia medievale."),
("Anna Karenina", 1.1, 16.99, 33, 11, "Libro", "Il classico di Lev Tolstoj che esplora l'amore, la passione e le convenzioni sociali nella Russia del XIX secolo."),
("L'Assassinio di Roger Ackroyd", 0.8, 12.99, 28, 12, "Libro", "Un romanzo giallo di Agatha Christie con il detective Hercule Poirot, famoso per il suo colpo di scena finale."),
("Piccole Donne", 1.2, 18.99, 50, 13, "Libro", "La storia delle sorelle March, scritta da Louisa May Alcott, che esplora l'amore, la crescita e la famiglia."),
("Il conte di Montecristo", 1.6, 23.99, 37, 14, "Libro", "Il capolavoro di Alexandre Dumas che racconta una storia di vendetta, inganno e redenzione."),
("Il vecchio e il mare", 0.9, 15.99, 29, 15, "Libro", "Un romanzo breve di Ernest Hemingway sulla lotta tra un vecchio pescatore cubano e un enorme pesce marlin."),
("Le mille e una notte", 1.3, 20.99, 43, 16, "Libro", "Una raccolta di storie e leggende arabe, ricche di avventura, magia e inganno."),
("Cinquanta sfumature di grigio", 1.2, 17.99, 55, 17, "Libro", "Un romanzo erotico di E.L. James che esplora una relazione complessa tra un giovane uomo e una donna."),
("Il Piccolo Principe", 0.7, 10.99, 60, 18, "Libro", "Una favola poetica di Antoine de Saint-Exupéry che racconta l'incontro tra un aviatore e un piccolo principe di un altro pianeta."),
("Guerra e pace", 1.8, 24.99, 25, 19, "Libro", "L'epopea di Lev Tolstoj che narra le vicende di diverse famiglie durante le guerre napoleoniche."),
("Il codice Da Vinci", 1.4, 19.99, 32, 20, "Libro", "Un thriller di Dan Brown che intreccia mistero, arte e storia in una caccia al tesoro attraverso l'Europa."),
("Il giorno della civetta", 1.0, 14.99, 27, 21, "Libro", "Un romanzo di Leonardo Sciascia che affronta la mafia in Sicilia con un approccio critico e realistico."),
("Il fu Mattia Pascal", 0.9, 16.99, 40, 10, "Libro", "Un romanzo di Luigi Pirandello che esplora l'identità e la ricerca di sé."),
("Il medico di corte", 1.1, 17.99, 34, 11, "Libro", "Una storia di avventura e intrigo ambientata in una corte imperiale."),
("La tregua", 1.5, 21.99, 22, 12, "Libro", "Un racconto autobiografico di Primo Levi che narra la liberazione dai campi di concentramento."),
("Il barone rampante", 1.2, 18.99, 30, 13, "Libro", "Un romanzo di Italo Calvino su un giovane nobile che decide di vivere sugli alberi per sfuggire alle convenzioni."),
("Il sole sorge ancora", 0.8, 13.99, 45, 14, "Libro", "Un romanzo di Ernest Hemingway che racconta le esperienze di un veterano di guerra."),
("Cent'anni di solitudine", 1.3, 22.99, 28, 15, "Libro", "Un capolavoro di Gabriel García Márquez che narra la storia della famiglia Buendía nel villaggio di Macondo."),
("Lo zoo di vetro", 1.0, 15.99, 36, 16, "Libro", "Una commedia di Tennessee Williams che esplora le fragilità della vita familiare e delle aspirazioni.");
