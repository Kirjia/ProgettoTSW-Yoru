...
<body>
	...
	<section class="container mt-5">
		...
		<div id="carouselProdotti" class="carousel slide"
						...
						<div class="col-md-3">
							<div class="card">
								<a href="Item?sku=${prodotto.SKU}"> <img
									...
									src="${pageContext.request.contextPath}/images/${prodotto.SKU}.jpg"
									alt="${prodotto.nome}" onerror="this.src='images/err.jpeg'">
								</a>
			...
			<a class="carousel-control-prev" href="#carouselProdotti"
				role="button" data-bs-slide="prev"> <span
				class="carousel-control-prev-icon" aria-hidden="true"></span> <span
				class="visually-hidden">Previous</span>
			</a> <a class="carousel-control-next" href="#carouselProdotti"
