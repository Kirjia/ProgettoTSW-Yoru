...
<body>
					...
					<div class="single-product card">
						...
						<div class="part-1">
							...
							<a href="Item?sku=${prodotto.SKU}" rel="noopener noreferrer"> <img
								...
								<!-- Overlay per OUT OF STOCK se quantità <= 0 --> <c:if
									test="${prodotto.quantità <= 0}">
						...
						<div class="part-2">
							...
							<button class="aggiungi-al-carrello" id="${prodotto.SKU}"
								data-type="libro"
								<c:choose>
	...
	<!-- Modal per conferma aggiunta al carrello -->
	<div class="modal fade" id="cartModal" tabindex="-1"
		aria-labelledby="modalCarrelloLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="modalCarrelloLabel">Aggiunto al
						carrello</h5>
